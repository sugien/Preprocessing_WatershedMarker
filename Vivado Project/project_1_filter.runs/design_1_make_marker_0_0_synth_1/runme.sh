...
HD_PWD='C:/Users/Caio/Dropbox/Vfilter_2/project_1_filter/project_1_filter.runs/design_1_make_marker_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_make_marker_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_make_marker_0_0.tcl
