...
#ifndef __make_marker_fcmp_fYi__HH__
#define __make_marker_fcmp_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(make_marker_fcmp_fYi) {
    ...
    SC_CTOR(make_marker_fcmp_fYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
