...
HD_PWD='C:/Users/Caio/Dropbox/Vfilter_2/project_1_filter/project_1_filter.runs/design_1_dlmb_bram_if_cntlr_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dlmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dlmb_bram_if_cntlr_2.tcl
