...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("inputStream_TDATA", 8, hls_in, 0, "axis", "in_data", 1),
	Port_Property("inputStream_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("inputStream_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("inputStream_TKEEP", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("inputStream_TSTRB", 1, hls_in, 2, "axis", "in_data", 1),
	Port_Property("inputStream_TUSER", 5, hls_in, 3, "axis", "in_data", 1),
	Port_Property("inputStream_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("inputStream_TID", 2, hls_in, 5, "axis", "in_data", 1),
	Port_Property("inputStream_TDEST", 6, hls_in, 6, "axis", "in_data", 1),
	Port_Property("outputStream_TDATA", 8, hls_out, 7, "axis", "out_data", 1),
	...
	Port_Property("outputStream_TKEEP", 1, hls_out, 8, "axis", "out_data", 1),
	Port_Property("outputStream_TSTRB", 1, hls_out, 9, "axis", "out_data", 1),
	Port_Property("outputStream_TUSER", 5, hls_out, 10, "axis", "out_data", 1),
	Port_Property("outputStream_TLAST", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("outputStream_TID", 2, hls_out, 12, "axis", "out_data", 1),
	Port_Property("outputStream_TDEST", 6, hls_out, 13, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "make_marker";
