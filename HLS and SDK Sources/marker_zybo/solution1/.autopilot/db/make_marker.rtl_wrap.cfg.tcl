...
set structArgument0 [list 8 5 2 6 ]
set NameSpace0 [list ]
set structIsPacked0 "0"
set DataType0 [list "ap_axiu<8, 5, 2, 6>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
set Port0 [list $PortName0 $Interface0 $DataType0 $Pointer0 $Dims0 $Const0 $Volatile0 $ArrayOpt0]
lappend PortList $Port0
set PortName1 "outputStream"
set BitWidth1 "56"
set ArrayOpt1 ""
set Const1 "0"
set Volatile1 "0"
...
set structArgument1 [list 8 5 2 6 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "ap_axis<8, 5, 2, 6>" "struct ap_axis" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
