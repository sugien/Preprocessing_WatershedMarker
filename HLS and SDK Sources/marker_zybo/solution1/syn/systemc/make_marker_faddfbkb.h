...
#ifndef __make_marker_faddfbkb__HH__
#define __make_marker_faddfbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(make_marker_faddfbkb) {
    ...
    SC_CTOR(make_marker_faddfbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
