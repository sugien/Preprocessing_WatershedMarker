...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename histData \
    op interface \
    ports { histData_address0 { O 8 vector } histData_ce0 { O 1 bit } histData_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'histData'"
}
}
